...
*/
$.fn.ghSpeedoMeter = function (userPref) {
  var self = this;
  ...
  var speedPositionTxtTop = speedPositionTxtTL + 32;   // Adjustment 
  ...
  this.createIndicators = function(){
    for(var i=0; i<=noOfDev; i++){
      ...
      induCatorNumbPosX = induCatorNumbPosX - 8;  // Adjustment 
  ...
  this.changeValue = function (value){   
    ...
    self.parentElem.find(".speedPosition").html(centerVal + " " + self.defaultProperty.gagueLabel );
